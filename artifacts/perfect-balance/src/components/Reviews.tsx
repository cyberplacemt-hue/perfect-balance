...
const allReviews = [
  ...
  },
  {
    ...
    stars: 5,
    date: "28 января 2025",
    product: "Гвозди БУЛАТ E4",
    text: "Гвозди E4 — просто огонь. Раньше брал Mustad, но после того как цены взлетели — перешёл на Гвозди БУЛАТ. Честно говоря, по качеству не хуже. Вхождение чистое, загиб ровный. Коробки 250 штук хватает примерно на месяц работы.",
    likes: 38,
    initials: "ДК",
    color: "#c8a84b",
  },
